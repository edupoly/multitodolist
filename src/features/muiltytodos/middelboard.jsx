...
function Middelboard(){
    ...
    return (
        <div>
         <Link to="/" style={{textDecoration:"none"}}> <h1 className="m-0 mb-0 p-2 " style={{backgroundColor:'#9fd3c7'}}>ALL BOARDS</h1></Link> 
        <div className="m-0  d-flex  justify-content-between  mt-0">
